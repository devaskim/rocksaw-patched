...
import static org.savarese.vserv.tcpip.ICMPPacket.*;
 ...
 *
 * <p>
 * Note, this is not a model of good programming. The point of the example is to show how the RawSocket API calls work. There is much kluginess surrounding the actual packet and protocol handling, all
 * of which is outside of the scope of what RockSaw does.
 * </p>
 *
...
public class Ping
{
  ...
  public static class Pinger
  {
    ...
    /**
     * @return The number of bytes in the data portion of the ICMP ping request packet.
     */
  ...
  public static class PingerIPv6 extends Pinger
  {
    ...
    /**
     * Operating system kernels are supposed to calculate the ICMPv6 checksum for the sender, but Microsoft's IPv6 stack does not do this. Nor does it support the IPV6_CHECKSUM socket option.
     * Therefore, in order to work on the Windows family of operating systems, we have to calculate the ICMPv6 checksum.
     */
